...
export function useTodo() {
            ...
            if (program && publicKey && !transactionPending) {
                try {
                    ...
                    if (profileAccount) {
                        ...
                        const todoAccs = await program.account.todoAccount.all([authorFilter(publicKey.toString())])
                        setTodos(todoAccs)
                    } else {
    ...
    }, [initialized, publicKey, program, transactionPending])
    ...
    return { initialized, initializeUser, addTodo, initializeStaticUser, loading, transactionPending, completedTodos, incompleteTodos, input, setInput, handleChange, markTodo, removeTodo }
}
